...
vehicles.removeAllPasengers = function(vehicle) {
    ...
    for(let p of vehicles.getOccupants(vehicle)) p.removeFromVehicle();
};
...
// new (Обходим баги рейджа через проверку на player.vehicle в радиусе авто)
/*
vehicles.getOccupants = function(vehicle) {
    if (!vehicles.exists(vehicle))
        return;
