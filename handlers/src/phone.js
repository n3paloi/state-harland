...
phone.show = function() {
    ...
    if (user.isCuff() || user.isTie()) {
        mp.game.ui.notifications.show("~r~Bağlandınız mı yoksa kelepçelendiniz mi");
        return;
    }
    if (pType == 0) {
        mp.game.ui.notifications.show("~r~Telefonunuz yok");
        return;
    }
    ...
    try {
        ...
        mp.game.ui.notifications.show(`~b~Telefonu gizle ~s~${bind.getKeyName(user.getCache('s_bind_phone'))}`);
...
phone.showOrHide = function() {
    ...
    if (user.getCache('jail_time') > 0) {
        mp.game.ui.notifications.show("~r~Telefonu hapishanede kullanamazsın");
        return;
    }
    if (user.isCuff() || user.isTie()) {
        mp.game.ui.notifications.show("~r~Bağlandınız mı yoksa kelepçelendiniz mi");
...
phone.updateMainAppList = function() {
    let appList = [
        { link: "/phone/android/umenu", action: 'app', img: 'apps', name: 'Uygulamalar.' },
        { link: "/phone/android/messenger", action: 'sms', img: 'sms', name: 'SMS' },
        { link: "/phone/android/phonebook", action: 'cont', img: 'cont', name: 'Temaslar' },
        //{ link: "/phone/android/umenu", action: 'settings', img: 'settings' },
        { link: "/phone/android/calls", action: 'calls', img: 'phone', name: 'Ziller' },
        ...
        { link: "/phone/android/umenu", action: 'browser', img: 'browser', name: 'Tarayıcı' },
        { link: "/phone/android/achiev", action: 'achiev', img: 'trophy', name: 'Başarılar' },
    ];
    ...
    if (user.getCache('family_id') > 0)
        appList.push({ link: "/phone/android/umenu", action: 'family', img: 'family', name: 'Aile' });
        ...
        items: [
            {
                ...
                umenu: [
                    ...
                    {
                        title: 'Arka plân',
                        text: `Arka planı seçin veya kendinizinkini yükleyin`,
                        type: 1,
            ...
            },
            {
                ...
                umenu: [
                    {
                        title: 'Polis',
                        text: `Polis memurlarına çağrı`,
                        modalTitle: 'Metni girin',
                        modalButton: ['Kapat', 'Göndermek'],
                        type: 8,
                        clickable: true,
                    ...
                    },
                    {
                        ...
                        text: `Sağlık görevlilerine çağrı`,
                        modalTitle: 'Metni girin',
                        modalButton: ['Kapat', 'Göndermek'],
                        type: 8,
                        clickable: true,
                    ...
                    {
                        title: 'Kurtarma Servisi',
                        text: `Kurtarma personeli çağrısı`,
                        modalTitle: 'Metni girin',
                        modalButton: ['Kapat', 'Göndermek'],
                        type: 8,
                        clickable: true,
            ...
            },
            {
                ...
                umenu: [
                    {
                        title: 'Balıkçılar Borsası',
                        text: 'Balıklar ve fiyatları hakkında eksiksiz bilgi',
                        type: 1,
                        params: { name: 'fishing' },
                        clickable: true
                    },
        ...
        items: [
            {
                ...
                umenu: [
                    ...
                    {
                        title: "Maaşınızı bozdurun",
                        modalTitle: 'Tutarı girin',
                        modalButton: ['İptal', 'Nakde çevir'],
                        type: 8,
                        clickable: true,
...
phone.showAppEcorp= function() {
    ...
    if (user.getCache('bank_card') > 0) {
        ...
        let item ={
                title: "Değiştirmek ₿ ile $",
                text: 'Курс: 1₿ = $500',
                modalTitle: 'Kaç ₿ takas etmek istiyorsun',
                modalButton: ['Kapat', 'Tercüme et'],
                type: 8,
                clickable: true,
